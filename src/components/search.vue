    ...
    <el-row type="flex" align="middle" class="container">
      <template v-for="(item, index) in _renderData">
        <el-col :xl="6" :lg="8" :key="index" v-show="isShow(index)">
          <el-form-item :label="item.label ? item.label : ' '" :class="[item.label?'':'not-label']">
      ...
      <el-col class="operation" :xl="{span: 6,offset: getXlOffset}" :lg="{span: 8,offset: getLgOffset}">
