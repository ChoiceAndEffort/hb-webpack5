<template>
    <el-dialog title="物料详情" :visible.sync="dialogFormVisible">
        ...
        data(){
            return{
                ...
                colConfig: [{
                   ...
                   attrs: { label: '零件编号', prop: 'partCode', align: 'center' ,width:"200px" },
               },{
                   attrs: { label: '零件编码', prop: 'partNumber', align: 'center' ,width:"200px" },
               },{
