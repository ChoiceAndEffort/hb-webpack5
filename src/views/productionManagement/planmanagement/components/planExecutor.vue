...
<template>
  <div class="main">
    ...
    <div class="list_table">
      ...
      <executor-box ref="executorBox"></executor-box>
    </div>
  </div>
</template>

<script>
import executorBox from "../executorBox.vue";
import { TableFilter, TableBody, Pagination } from "gggj_lib";
export default {
  components: { TableFilter, TableBody, Pagination, executorBox },
  data() {
    return {
      searchobj: {
        projectName: "",
  ...
  methods: {
    ...
    /* 选择执行人 */
    selectPerson(row) {
      this.$refs.executorBox.initUser();
    },
    /* 合并表格的方法 */
